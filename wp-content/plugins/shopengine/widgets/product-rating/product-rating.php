...
class ShopEngine_Product_Rating extends \ShopEngine\Base\Widget
{
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shopengine_rating_singular_label',
			[
				'label' => esc_html__('Rating Singular Label', 'shopengine'),
				'type'  => Controls_Manager::TEXT,
				'label_block' => true,
				'description'	=> esc_html__('Will display when 1 review', 'shopengine'),
			]
		);
		$this->add_control(
			'shopengine_rating_plural_label',
			[
				'label' => esc_html__('Rating Plural Label', 'shopengine'),
				'type'  => Controls_Manager::TEXT,
				'label_block' => true,
