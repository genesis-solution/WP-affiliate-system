...
class Woostify_Sites_Redux_Importer {
	/**
	...
	public static function import( $import_data ) {
		...
		foreach ( $import_data as $redux_item ) {
			...
			if ( isset( $redux_framework->args['opt_name'] ) ) {
				...
				Woostify_Sites_Logger::get_instance()->debug( __( 'The Redux Framework data was imported' , 'woostify-sites-library'), $redux_item );
			}
		}
