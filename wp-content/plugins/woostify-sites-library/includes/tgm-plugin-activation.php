 ...
 * @subpackage Example
 * @version    2.6.1 for plugin Woostify Sites Library
...
add_action( 'tgmpa_register', 'woostify_sites_register_required_plugins' );
 ...
 */
function woostify_sites_register_required_plugins() {
	/*
