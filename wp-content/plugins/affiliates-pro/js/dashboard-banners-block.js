...
if ( typeof wp !== 'undefined' ) {
	...
	//
	// The Affiliates Dashboard Banners block.
	...
	wp.blocks.registerBlockType(
		'affiliates/dashboard-banners',
		{
			title       : 'Affiliates Dashboard Banners',
			description : 'Banners section for the Affiliates Dashboard',
			icon        : 'images-alt',
			category    : 'affiliates',
			keywords    : [ affiliates_dashboard_banners_block.keyword_affiliates, affiliates_dashboard_banners_block.keyword_dashboard, affiliates_dashboard_banners_block.keyword_login ],
			supports    : { html : false },
			attributes  : {
				header_tag : {
					type : 'string'
				...
				var header_tag = props.attributes.header_tag || 'h2',
					...
					fields = [
						...
						wp.element.createElement(
							...
							{
								block : 'affiliates/dashboard-banners',
						...
						wp.element.createElement(
							...
							affiliates_dashboard_banners_block.dashboard_banners_notice
						)
					];
				return fields;
			},
