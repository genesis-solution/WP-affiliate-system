...
if ( typeof wp !== 'undefined' ) {
	...
	//
	// The Affiliates Dashboard Traffic block.
	...
	wp.blocks.registerBlockType(
		'affiliates/dashboard-traffic',
		{
			title       : 'Affiliates Dashboard Traffic',
			description : 'Traffic section for the Affiliates Dashboard',
			icon        : 'analytics',
			category    : 'affiliates',
			keywords    : [ affiliates_dashboard_traffic_block.keyword_affiliates, affiliates_dashboard_traffic_block.keyword_dashboard, affiliates_dashboard_traffic_block.keyword_login ],
			supports    : { html : false },
			attributes  : {
				header_tag : {
					type : 'string'
				...
				var header_tag = props.attributes.header_tag || 'h2',
					...
					fields = [
						...
						wp.element.createElement(
							...
							{
								block : 'affiliates/dashboard-traffic',
						...
						wp.element.createElement(
							...
							affiliates_dashboard_traffic_block.dashboard_traffic_notice
						)
					];
				return fields;
			},
