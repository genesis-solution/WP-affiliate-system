...
if ( typeof wp !== 'undefined' ) {
	...
	//
	// The Affiliates Dashboard Referrals block.
	...
	wp.blocks.registerBlockType(
		...
		{
			title       : 'Affiliates Dashboard Referrals',
			description : 'Referrals section for the Affiliates Dashboard',
			icon        : 'book',
			category    : 'affiliates',
			keywords    : [ affiliates_dashboard_referrals_block.keyword_affiliates, affiliates_dashboard_referrals_block.keyword_dashboard, affiliates_dashboard_referrals_block.keyword_login ],
			supports    : { html : false },
			attributes  : {
				header_tag : {
					type : 'string'
				...
				var header_tag = props.attributes.header_tag || 'h2',
					...
					fields = [
						...
						wp.element.createElement(
							...
							{
								block : 'affiliates/dashboard-referrals',
						...
						wp.element.createElement(
							...
							affiliates_dashboard_referrals_block.dashboard_referrals_notice
						)
					];
				return fields;
			},
