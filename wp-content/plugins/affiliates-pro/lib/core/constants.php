...
define('AFFILIATES_SHARE_TOKEN_AFFILIATES', 'aff_share_token_affiliates');
...
/**
 * @var string shoplist status accepted
 */
define( 'AFFILIATES_SHOPLIST_STATUS_ACCEPTED', 'accepted' );

/**
 * @var string shoplist status rejected
 */
...
/**
 * @var string purchased_view status accepted
 */
define( 'AFFILIATES_PURCHASED_VIEW_STATUS_ACCEPTED', 'accepted' );

/**
 * @var string purchased status rejected
 */
define( 'AFFILIATES_PURCHASED_VIEW_STATUS_REJECTED', 'rejected' );
