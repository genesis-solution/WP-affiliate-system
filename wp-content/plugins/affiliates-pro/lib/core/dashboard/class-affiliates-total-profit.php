<?php
/**
 * class-affiliates-total-profit.php
 *
 ...
 */
class Affiliates_Total_Profit extends Affiliates_Dashboard_Section_Table {
    ...
    public function __construct( $params = array() ) {
        $this->template = 'dashboard/total_profit.php';
        ...
        $this->columns['period'] = array(
            ...
            'description' => __( '所賺取金額的盈利期。', 'affiliates' )
        );
        $this->columns['earnings'] = array(
            'title'       => __( '收益', 'affiliates' ),
            'description' => __( '涵蓋期間的收入。', 'affiliates' )
        );
        $this->columns['paid'] = array(
            'title'       => __( '有薪酬的', 'affiliates' ),
            'description' => __( '所涵蓋期間支付的收入。', 'affiliates' )
        );
    }
