			...
			if ( $expanded || $expanded_referrals || $expanded_hits ) {
				...
				if ( $expanded_referrals ) {
					...
					if ( count( $referrals) > 0 ) {
						...
						$output .= '<p class="description">' . esc_html__( '推薦人', 'affiliates' ) . '</p>';
						$output .= '<table id="details-referrals-' . esc_attr( $result->date ) . '" class="details-referrals" cellspacing="0">';
						$output .= '<thead>';
						$output .= '<tr>';
						$output .= '<th scope="col" class="datetime">' . esc_html__('日期', 'affiliates' ) . '</th>';
						$output .= '<th scope="col" class="post-id">' . esc_html__('郵政', 'affiliates' ) . '</th>';
						$output .= '<th scope="col" class="affiliate-id">' . esc_html__('附屬機構', 'affiliates' ) . '</th>';
						$output .= '</tr>';
						$output .= '</thead>';
						$output .= '<tbody>';
				...
				if ( $expanded_hits ) {
					...
					$output .= '<p class="description">' . esc_html__('點擊數', 'affiliates' ) . '</p>';
					...
					$output .= '<th scope="col" class="affiliate-id">' . esc_html__('附屬機構', 'affiliates' ) . '</th>';
					$output .= '<th scrope="col" class="src-uri">' . esc_html__('源 URI', 'affiliates' ) . '</th>';
					$output .= '<th scrope="col" class="src-uri">' . esc_html__('登陸 URI', 'affiliates' ) . '</th>';
					$output .= '<th scope="col" class="hit-user-agent">' . esc_html__('用戶代理', 'affiliates' ) . '</th>';
					$output .= '</tr>';
					$output .= '</thead>';
					$output .= '<tbody>';
					foreach ( $hits as $hit ) {
