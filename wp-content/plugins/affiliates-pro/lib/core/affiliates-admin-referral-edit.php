...
function affiliates_admin_referral_edit( $referral_id = null ) {
	...
	$output .= '<p>';
	$output .= '<label>';
	$output .= '<span class="title">' . __('附屬機構', 'affiliates' ) . '</span>';
	$output .= ' ';
	...
	$output .= '<p>';
	$output .= '<label>';
	$output .= '<span class="title">' . __('數量', 'affiliates' ) . '</span>';
	$output .= ' ';
	...
	$output .= '<p>';
	$output .= '<label>';
	$output .= '<span class="title">' . __('地位', 'affiliates' ) . '</span>';
	$output .= ' ';
	...
	$output .= sprintf( '<input class="button button-primary" type="submit" name="save" value="%s"/>', __('節省', 'affiliates' ) );
	$output .= ' ';
	$output .= sprintf( '<a class="cancel button" href="%s">%s</a>', $cancel_url, $saved ? __( 'Back', 'affiliates' ) : __('取消', 'affiliates' ) );
